...
from dotenv import load_dotenv  # استيراد دالة تحميل متغيرات البيئة

# تحميل المتغيرات من ملف .env الموجود في نفس مجلد المشروع الرئيسي
load_dotenv()
...
# استدعاء الروابط والمفاتيح من متغيرات البيئة بدلاً من كتابتها صراحة
CNN_ENDPOINT = os.getenv("CNN_ENDPOINT")
CNN_KEY = os.getenv("CNN_KEY")

OD_ENDPOINT = os.getenv("OD_ENDPOINT")
OD_KEY = os.getenv("OD_KEY")
